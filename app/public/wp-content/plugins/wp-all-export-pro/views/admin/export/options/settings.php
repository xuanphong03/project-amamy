                        ...
                        <td colspan="3">
                            ...
                            <div class="wpallexport-no-realtime-options <?php if ($post['enable_real_time_exports']) { ?> wpae-hidden <?php } ?>"  >
                                <div class="input">
                                    <label for="records_per_request"><?php esc_html_e('In each iteration, process', 'wp_all_export_plugin'); ?>
                                        <input type="text" name="records_per_iteration" class="wp_all_export_sub_input records_per_iteration"
                            ...
                            if ('advanced' !== $post['export_type']) {
                                if ($cpt_name !== 'taxonomies') {
                                    ...
                                    <div class="input">
                                        ...
                                        <input type="checkbox"
                                               id="enable_real_time_exports" <?php if ((isset($post['xml_template_type']) && $post['xml_template_type'] == XmlExportEngine::EXPORT_TYPE_GOOLE_MERCHANTS) || $cpt_name === 'shop_customer' || $cpt_name === 'shop_guest_customer') { ?> disabled="disabled" <?php } ?>
                            ...
                            <div class="wpallexport-no-realtime-options <?php if ($post['enable_real_time_exports']) { ?> wpae-hidden <?php } ?>">
                                ...
                                <div class="input">
                                    ...
                                    <input type="checkbox"
                                        <?php if (in_array('users', $post['cpt']) || in_array('taxonomies', $post['cpt']) || in_array('shop_customer', $post['cpt']) || in_array('shop_guest_customer', $post['cpt']) || ($post['export_type'] === 'advanced' && $post['wp_query_selector'] === 'wp_user_query')) { ?> disabled="disabled" <?php } ?>
                                    ...
                                    <a href="#help" class="wpallexport-help"
                                        ...
                                        <?php } else if (in_array('shop_guest_customer', $post['cpt'])) { ?>
                                            title="<?php esc_html_e('This feature is not available for guest customer exports.', 'wp_all_export_plugin'); ?>"
                                        <?php } else { ?>
                            ...
                            <?php if (in_array('shop_customer', $post['cpt']) || in_array('shop_guest_customer', $post['cpt'])) { ?>
                                <div class="input">
                            ...
                            if (current_user_can(PMXE_Plugin::$capabilities)) {
                                ...
                                <div class="input">
                                    <label class="save_import_as_label" for="save_import_as"><?php esc_html_e('Export Name:', 'wp_all_export_plugin'); ?></label>
