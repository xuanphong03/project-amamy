...
if ( ! class_exists( 'WP_Sheet_Editor_Factory' ) ) {
	...
	class WP_Sheet_Editor_Factory {
		...
		function __construct( $args = array() ) {
			...
			add_action( 'admin_init', array( $this, 'disable_betterlinks_noconflict_mode_on_editor_page' ) );
		}

		function disable_betterlinks_noconflict_mode_on_editor_page() {
			if ( VGSE()->helpers->is_editor_page() ) {
				add_filter( 'BetterLinks/Admin/skip_no_conflict', '__return_true', 9999 );
			}
		}
