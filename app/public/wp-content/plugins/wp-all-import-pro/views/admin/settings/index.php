...
if (file_exists($functions) && PMXI_Plugin::$is_php_allowed):
    ...
    <div class="input" style="margin-top: 10px;">
        <div class="input" style="display:inline-block; margin-right: 20px;">
            ...
            <a href="#help" class="wpallimport-help" title="<?php printf(__("Add functions here for use during your import. You can access this import file at %s", "wp-all-import-pro"), preg_replace("%.*wp-content%", "wp-content", $functions));?>" style="top: 0;">?</a>
